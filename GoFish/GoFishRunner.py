...
def parse_arguments():
  parser = argparse.ArgumentParser(description = 'Configuration Manager for GoFish')
...
def main():
    ...
    for i in range(args.simulations):
        ...
        for i in range(args.players):
            players.append(GoFishPlayer(False, i, name='Player ' + str(i)))
        for i in range(args.computers):
            players.append(GoFishPlayer(True, i + args.players, name='Computer ' + str(i)))
