...
def parse_arguments():
  parser = argparse.ArgumentParser(description = 'Configuration Manager for SnipSnapSnorem')
...
def main():
    ...
    for i in range(args.simulations):
        ...
        for i in range(args.players):
            players.append(SnipSnapSnoremPlayer(False, i, name='Player ' + str(i)))
        for i in range(args.computers):
            players.append(SnipSnapSnoremPlayer(True, i + args.players, name='Computer ' + str(i)))
        ...
        game = SnipSnapSnoremGame(env, ui)
